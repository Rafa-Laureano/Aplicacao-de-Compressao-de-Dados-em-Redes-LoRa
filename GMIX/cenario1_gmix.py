...
# Funcao para executar o GMIX e capturar a saida
def run_gmix(gmix_path, input_file, output_file):
    start_time = time.time()
    result = subprocess.run([gmix_path, '-c', input_file, output_file], capture_output=True, text=True)
    end_time = time.time()
    ...
    if match:
        ...
        compression_rate = (1 - (size_after / size_before))   # Calcular a taxa de compressao em porcentagem
...
def perform_multiple_compressions(gmix_path, lines, num_messages, iterations=1):
    ...
    for _ in range(iterations):
        ...
        size_before, size_after, compression_rate, elapsed_time = run_gmix(gmix_path, temp_file_path, output_file_path)
    ...
    avg_compression_rate = (total_compression_rate / iterations) *100
...
input_file_path = '/home/rafaella/Desktop/raspberry5/experimentos/gmix/gmix-main/mensagens_iot_diversificado.txt'
temp_file_path = '/home/rafaella/Desktop/raspberry5/experimentos/gmix/gmix-main/temp_input.txt'
gmix_path = '/home/rafaella/Desktop/raspberry5/experimentos/gmix/gmix-main/gmix'
output_file_base_path = '/home/rafaella/Desktop/raspberry5/experimentos/gmix/gmix-main/output'
log_file_path = '/home/rafaella/Desktop/raspberry5/experimentos/gmix/gmix-main/compressao_diversificado_gmix.txt'
