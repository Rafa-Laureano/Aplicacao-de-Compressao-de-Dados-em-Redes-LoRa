...
def compress_file(input_file, output_file):
    ...
    subprocess.run(['./bsc-m03', 'e', input_file, output_file])
    end_time = time.time()
...
def main():
    input_file_path = '/home/rafaella/Desktop/raspberry5/experimentos/bsc/bsc-m03/build/mensagens_iot_diversificado.txt'
    log_file_path = 'compressao_bsc_diversificado.txt'
    ...
    with open(log_file_path, 'w') as log_file:
        log_file.write('mensagem,tamanho_original,tamanho_comprimido,taxa_compressao,tempo_medio,sf12_max_messages,sf7_max_messages\n')
