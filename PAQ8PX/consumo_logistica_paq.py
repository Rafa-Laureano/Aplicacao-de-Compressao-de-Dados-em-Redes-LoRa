...
def monitor_resources(process, stop_event, cpu_readings, mem_readings, sampling_interval=0.1):
...
def main():
    ...
    output_csv = "consumo_logistica_paq.csv"
    ...
    with open(output_csv, "w", newline='') as csvfile:
        ...
        for num_msg in range(1, 41):
            try:
                ...
                output_file = f"paq_compressed_{num_msg}.bin"
                
                # Escreve arquivo temporário
                write_temp_file(data, temp_input_file)
                
                # Comando de compressão
                compress_cmd = ["./paq8px", "-8", temp_input_file, output_file]
